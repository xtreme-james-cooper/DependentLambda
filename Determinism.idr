...
deterministicEval (EvIsZero1 ev1) (EvIsZero1 ev2) =
    rewrite deterministicEval ev1 ev2 in Refl
...
deterministicEval (EvIsZero1 ev1) (EvIsZeroLet v) = void (valNoEval (LetVal v) ev1)
...
deterministicEval (EvIsZeroLet v) (EvIsZero1 ev2) = void (valNoEval (LetVal v) ev2)
deterministicEval (EvIsZeroLet v) (EvIsZeroLet v2) = Refl
