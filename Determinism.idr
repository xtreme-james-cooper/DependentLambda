...
deterministicEval (EvLet3 vh1 (LetVal v1 npr) neq) (EvLetLet vh2 v2 npr') = void (neq (_ ** _ ** _ ** Refl))
deterministicEval (EvLet3 vh1 v1 neq) (EvLetGC v2 nfv2) = void (eqFlip' nfv2 (varHeadedMustBeFree vh1))
...
deterministicEval (EvLetLet vh11 v12 npr) (EvLet3 vh22 (LetVal v22 npr') neq) = void (neq (_ ** _ ** _ ** Refl))
...
deterministicEval (EvLetGC v1 nfv1) (EvLet3 vh22 v22 neq) = void (eqFlip' nfv1 (varHeadedMustBeFree vh22))
deterministicEval (EvLetGC v1 nfv1) (EvLetLet vh22 v22 npr) = void (eqFlip' nfv1 (varHeadedMustBeFree vh22))
deterministicEval (EvLetGC v1 nfv1) (EvLetGC v2 nfv2) = ?argl13
